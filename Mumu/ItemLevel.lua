...
local tiers = {
	-- myth
	[1] = { ["score"] = 684, ["color"] = { 1.00, 0.50, 0.00 } },		-- #ff8000		
	[2] = { ["score"] = 681, ["color"] = { 0.98, 0.47, 0.19 } },		-- #fb7831
	[3] = { ["score"] = 678, ["color"] = { 0.96, 0.44, 0.29 } },		-- #f6714a
	[4] = { ["score"] = 675, ["color"] = { 0.95, 0.41, 0.38 } },		-- #f16960
	[5] = { ["score"] = 671, ["color"] = { 0.92, 0.38, 0.45 } },		-- #eb6274
	[6] = { ["score"] = 668, ["color"] = { 0.89, 0.35, 0.53 } },		-- #e45a87
	[7] = { ["score"] = 665, ["color"] = { 0.86, 0.33, 0.61 } },		-- #dc539b
	[8] = { ["score"] = 662, ["color"] = { 0.82, 0.29, 0.68 } },		-- #d24bae

	-- 	hero
	[9] = { ["score"] = 658, ["color"] = { 0.78, 0.27, 0.76 } },		-- #c744c1
	[10] = { ["score"] = 655, ["color"] = { 0.73, 0.24, 0.83 } },		-- #ba3dd4
	[11] = { ["score"] = 652, ["color"] = { 0.66, 0.22, 0.91 } },		-- #a937e7
	[12] = { ["score"] = 649, ["color"] = { 0.59, 0.26, 0.93 } },		-- #9742ec

	-- 	champion
	[13] = { ["score"] = 645, ["color"] = { 0.51, 0.32, 0.91 } },		-- #8351e8
	[14] = { ["score"] = 642, ["color"] = { 0.43, 0.36, 0.90 } },		-- #6d5de5
	[15] = { ["score"] = 639, ["color"] = { 0.32, 0.40, 0.89 } },		-- #5266e2
	[16] = { ["score"] = 636, ["color"] = { 0.15, 0.43, 0.87 } },		-- #276ede

	-- Veteran
	[17] = { ["score"] = 632, ["color"] = { 0.13, 0.46, 0.84 } },		-- #2275d7
	[18] = { ["score"] = 629, ["color"] = { 0.22, 0.49, 0.81 } },		-- #377dcf
	[19] = { ["score"] = 626, ["color"] = { 0.27, 0.52, 0.78 } },		-- #4485c7
	[20] = { ["score"] = 623, ["color"] = { 0.30, 0.55, 0.75 } },		-- #4d8dbe

	-- advanture
	[21] = { ["score"] = 619, ["color"] = { 0.33, 0.58, 0.71 } },		-- #5495b6
	[22] = { ["score"] = 616, ["color"] = { 0.35, 0.62, 0.68 } },		-- #50a0bd
	[23] = { ["score"] = 613, ["color"] = { 0.26, 0.61, 0.68 } },		-- #419CAC
	[24] = { ["score"] = 610, ["color"] = { 0.20, 0.60, 0.60 } },		-- #32989A
...
local scoreTiers = {
	...
	[27] = { ["score"] = 0, ["color"] = { 0.33, 0.39, 0.45 } },			-- #566573
}
...
local function AddInfoToTooltip(tooltip, unit)
	GetItemLevelAndInfo(unit, function(avgItemLevel, mythicScore, spec)
		...
		for i = tooltip:NumLines(), 1, -1 do
            ...
            if line and line:GetText() and line:GetText() == "불러오는 중" then
					--print("\124cFFEC407A"..line:GetText().."\124r")
					line:SetText(nil)
			end
        end
